...
class CancerRandomForest:
    ...
    def train_model(self, random_state=42):
        ...
        # Train the model (using scaled data for consistency)
    ...
    def evaluate_model(self):
        ...
        plt.tight_layout()
        plt.savefig('Graphs/confusion_matrix_random_forest.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def save_model(self, model_filename='ModelWeights/random_forest_model.pkl', 
                   scaler_filename='ModelWeights/scaler_rf.pkl'):
    ...
    def run_complete_pipeline(self):
        ...
        print("="*60)
        print("RANDOM FOREST PIPELINE FOR CANCER CLASSIFICATION")
        print("="*60)
...
def main():
    ...
    cancer_rf = CancerRandomForest('cancer.csv')
    
    # Run the complete pipeline
    metrics = cancer_rf.run_complete_pipeline()
