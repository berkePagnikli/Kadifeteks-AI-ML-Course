...
class CancerCatBoost:
    def __init__(self, data_path):
        """Initialize the CatBoost class"""
    ...
    def evaluate_model(self):
        ...
        plt.tight_layout()
        plt.savefig('Graphs/confusion_matrix_catboost.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def save_model(self, model_filename='ModelWeights/catboost_model.pkl', 
                   scaler_filename='ModelWeights/scaler_cb.pkl'):
    ...
    def run_complete_pipeline(self):
        ...
        print("="*60)
        print("CATBOOST PIPELINE FOR CANCER CLASSIFICATION")
        print("="*60)
...
def main():
    """Main function to run the CatBoost pipeline"""
    # Initialize the cancer classification system
    cancer_cb = CancerCatBoost('cancer.csv')
    
    # Run the complete pipeline
    metrics = cancer_cb.run_complete_pipeline()
