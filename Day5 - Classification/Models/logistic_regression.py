...
class CancerLogisticRegression:
    ...
    def evaluate_model(self):
        ...
        plt.tight_layout()
        plt.savefig('Graphs/confusion_matrix_logistic_regression.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def save_model(self, model_filename='ModelWeights/logistic_regression_model.pkl', 
                   scaler_filename='ModelWeights/scaler.pkl'):
    ...
    def run_complete_pipeline(self):
        ...
        print("="*60)
        print("LOGISTIC REGRESSION PIPELINE FOR CANCER CLASSIFICATION")
        print("="*60)
...
def main():
    ...
    cancer_lr = CancerLogisticRegression('cancer.csv')
    
    # Run the complete pipeline
    metrics = cancer_lr.run_complete_pipeline()
