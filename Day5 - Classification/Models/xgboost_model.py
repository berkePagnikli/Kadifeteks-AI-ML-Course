...
class CancerXGBoost:
    ...
    def split_and_scale_data(self, test_size=0.2, random_state=42):
        ...
        # Scale the features (recommended for XGBoost for better performance)
    ...
    def evaluate_model(self):
        ...
        plt.tight_layout()
        plt.savefig('Graphs/confusion_matrix_xgboost.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def save_model(self, model_filename='ModelWeights/xgboost_model.pkl', 
                   scaler_filename='ModelWeights/scaler_xgb.pkl'):
    ...
    def run_complete_pipeline(self):
        ...
        print("="*60)
        print("XGBOOST PIPELINE FOR CANCER CLASSIFICATION")
        print("="*60)
...
def main():
    ...
    cancer_xgb = CancerXGBoost('cancer.csv')
    
    # Run the complete pipeline
    metrics = cancer_xgb.run_complete_pipeline()
