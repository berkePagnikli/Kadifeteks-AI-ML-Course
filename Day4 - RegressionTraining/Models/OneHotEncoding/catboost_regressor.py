...
encoder = OneHotEncoder(
    ...
    handle_unknown='ignore'   # Ignore unknown categories during transform (assign zeros)
)

# Apply one-hot encoding to categorical features
# This converts each categorical value to a binary vector (e.g., 'Red' → [1,0,0], 'Blue' → [0,1,0])
...
# CatBoost will work with the binary features created by one-hot encoding
