...
model = xgb.XGBRegressor(
    ...
    enable_categorical=True  # Enable native categorical feature support in XGBoost
)

# Train the model on the training data
# XGBoost will build an ensemble of decision trees iteratively
...
with open('ModelWeights/xgboost_regressor.pkl', 'wb') as f:
    pickle.dump(model, f)
...
model_components = {
    ...
    'model_type': 'XGBRegressor'             # Model type identifier
}

# Save model components and metadata using pickle for future inference
with open('ModelWeights/xgboost_regressor_components.pkl', 'wb') as f:
